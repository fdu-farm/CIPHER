"""Utility for exporting a CIPHER diffusion pipeline from saved checkpoints.

This helper mirrors the training configuration so the same fine-tuned backbone
can be reused for Path 1-4 generation and editing workflows.
"""
