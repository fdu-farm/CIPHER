...
class BaseConfig:
    ...
    use_ema: bool = False
    # SNR weighting and noise offset for diffusion training.
...
def build_config(config_dict):
    ...
    valid_keys = {field.name for field in fields(BaseConfig)}
